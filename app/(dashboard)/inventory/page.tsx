...
interface Item { product_id: number; product_name: string; category_name: string; total_stock: number; available_stock: number }
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {filtered.length === 0 && <tr><td colSpan={6} className="px-4 py-8 text-center text-gray-400">No items found</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
